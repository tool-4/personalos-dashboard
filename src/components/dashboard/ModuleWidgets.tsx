...
const modules = [
  { icon: Target, title: 'Goals', value: '82%', label: 'Q2 Projects', color: '#6366f1', status: 'On Track' },
  { icon: Clock, title: 'Time', value: '4.2h', label: 'Deep Work', color: '#0ea5e9', status: 'Good' },
  { icon: Zap, title: 'Health', value: '92', label: 'Sleep Score', color: '#10b981', status: 'Peak' },
  { icon: Wallet, title: 'Money', value: '$12.4k', label: 'Net Change', color: '#f59e0b', status: '+2.4%' },
  { icon: Brain, title: 'Mind', value: '15m', label: 'Meditation', color: '#8b5cf6', status: 'Daily' },
];
